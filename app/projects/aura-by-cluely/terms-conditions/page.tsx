    ...
    <div className="min-h-screen bg-white text-[#4a5568] flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 max-w-3xl">
        <div className="prose prose-gray max-w-none">
          <h1 className="text-3xl md:text-4xl font-bold text-[#2d3748] mb-6">Terms & Conditions</h1>
          
          <p>These terms and conditions apply to the Aura by Cluely app (hereby referred to as "Application") for mobile devices that was created by Ian Carscadden (hereby referred to as "Service Provider") as a Free service.</p>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4">Updates and Termination</h2>
          ...
          <p>These terms and conditions are effective as of 2025-07-17</p>
